...
module bird(clk_i, rst_ni, next_frame_i, spawn_i, rand_i, pixel_x_i, pixel_y_i, pixel_o);
  ...
  assign _20_ = BIRD_DOWN[_31_[5:1]];
  ...
  \$reduce_and  #(
    ...
    .A({ spawn_i, off_screen, next_frame_i }),
    .Y(_10_)
  );
  \$reduce_and  #(
    .A_SIGNED(32'd0),
  ...
  assign _30_[30:1] = { _30_[31], _30_[31], _30_[31], _30_[31], _30_[31], _30_[31], _30_[31], _30_[31], _30_[31], _30_[31], _30_[31], _30_[31], _30_[31], _30_[31], _30_[31], _30_[31], _30_[31], _30_[31], _30_[31], _30_[31], _12_ };
  assign _sv2v_0 = 1'h0;
  assign rom_y = _31_[5:1];
endmodule
...
module dino(clk_i, rst_ni, next_frame_i, up_i, down_i, hit_i, pixel_x_i, pixel_y_i, pixel_o);
  ...
  assign _25_ = DINO_DOWNLEFT[_16_];
  ...
  assign _26_ = DINO_DOWNRIGHT[_16_];
  ...
  assign _30_ = DINO_STANDING[_16_];
  \$add  #(
    .A_SIGNED(32'd0),
    .A_WIDTH(32'd8),
    .B_SIGNED(32'd0),
...
module dinorun(clk_25_175_i, rst_ni, start_i, up_i, down_i, digit0_en_o, digit0_o, digit1_en_o, digit1_o, digit2_en_o, digit2_o, digit3_en_o, digit3_o, vga_red_o, vga_green_o, vga_blue_o, vga_hsync_o, vga_vsync_o);
  ...
  assign _sv2v_0 = 1'h0;
  assign cactus_reset = bird_reset;
  assign digit0_en_o = 1'h1;
  assign digit1_en_o = 1'h1;
  assign digit2_en_o = 1'h1;
  assign digit3_en_o = 1'h1;
  assign dino_reset = bird_reset;
  assign lsfr_reset = bird_reset;
  assign nextframe_cactus = nextframe_bird;
  assign nextframe_dino = nextframe_bird;
  assign score_reset = bird_reset;
  assign vga_blue_o = vga_red_o;
  assign vga_green_o = vga_red_o;
endmodule
...
module vga_timer(clk_i, rst_ni, hsync_o, vsync_o, visible_o, position_x_o, position_y_o);
  ...
  output [9:0] position_y_o;
  wire [9:0] position_y_o;
  input rst_ni;
  wire rst_ni;
  wire [9:0] v_d;
  wire [9:0] v_q;
