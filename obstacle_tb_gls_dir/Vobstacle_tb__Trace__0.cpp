...
void Vobstacle_tb___024root__trace_chg_0_sub_0(Vobstacle_tb___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[1U] 
        ...
        bufp->chgCData(oldp+49,((0x3fU & (((IData)(vlSelf->obstacle_tb__DOT__pixel_y_i) 
                                           - (IData)(0x4eU)) 
                                          >> 1U))),6);
    }
    ...
    bufp->chgSData(oldp+64,((0x3ffU & ((IData)(0x14U) 
                                       - ((IData)(vlSelf->obstacle_tb__DOT__bird__DOT____Vcellout___67___Y) 
                                          >> 1U)))),10);
    bufp->chgCData(oldp+65,((0x1fU & ((IData)(vlSelf->obstacle_tb__DOT__bird__DOT___31_) 
                                      >> 1U))),5);
    bufp->chgBit(oldp+66,(((IData)(vlSelf->obstacle_tb__DOT__next_frame_i) 
