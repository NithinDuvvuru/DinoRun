...
void Vobstacle_tb___024root___eval_triggers__act(Vobstacle_tb___024root* vlSelf) {
    ...
    // Body
    vlSelf->__VactTriggered.set(0U, (vlSelf->obstacle_tb__DOT__cactus__DOT___08_ 
                                     != vlSelf->__Vtrigprevexpr___TOP__obstacle_tb__DOT__cactus__DOT___08___1));
    vlSelf->__VactTriggered.set(1U, (vlSelf->obstacle_tb__DOT__bird__DOT___12_ 
    ...
    vlSelf->__VactTriggered.set(4U, ((~ (IData)(vlSelf->obstacle_tb__DOT__clk_i)) 
                                     & (IData)(vlSelf->__Vtrigprevexpr___TOP__obstacle_tb__DOT__clk_i__0)));
    vlSelf->__Vtrigprevexpr___TOP__obstacle_tb__DOT__cactus__DOT___08___1 
